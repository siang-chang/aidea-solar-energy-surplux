...
| 項目 | 方法                                                                                             | RMSE      |
| :--- | :----------------------------------------------------------------------------------------------- | :-------- |
| 1    | 基於經緯度、模組及裝置容量分組，再以預測日的觀測及晴空輻射為輸入變數訓練[^8] XGboost 預估發電量  | 271.40773 |
...
| 項目 | 方法                                                                          | RMSE      |
| :--- | :---------------------------------------------------------------------------- | :-------- |
| 1    | 將 14 個發電廠依據緯度分組，再以預測日的輻射為輸入變數訓練 XGboost 預估發電量 | 276.31831 |
| 2    | 將 14 個發電廠依據經度分組，再以預測日的輻射為輸入變數訓練 XGboost 預估發電量 | 269.63295 |
| 3    | 延續基於經度分組的架構，並在輸入變數[^13]追加裝置容量及過去 1 日的輻射        | 238.85634 |

1. xgb_groupby_lat_1d_doyt_normalized_outlier_replace
2. xgb_groupby_lon_1d_doyt_normalized_outlier_replace
3. xgb_groupby_lon_1d_doyt_prev1d_capacity_normalized_outlier
...
| 項目 | 方法                                                              | RMSE      |
| :--- | :---------------------------------------------------------------- | :-------- |
| 1    | 延續基於經度分組的架構，並在輸入變數追加裝置容量及過去 1 日的輻射 | 238.85634 |
